...
(lex.add.entry '("est_à_dire" VER (((eh) 0) ((t a) 0) ((d i rh) 0))))
...
; ;;; 
; ;_("n'est-ce_pas" ADV 
; QT3 (lex.add.entry '("chat_en-jambes" VER (((sh a) 0) ((t ahn)0)((zh ahn b) 0))));
; QT3 (lex.add.entry '("peut_être" VER (((p eu) 0) ((t eh t rh) 0))))
